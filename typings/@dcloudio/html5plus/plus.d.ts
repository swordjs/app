...
interface PlusKey {
   ...
   */
  addEventListener(
    event: 'backbutton' | 'keydown' | 'keyup' | 'longpressed' | 'menubutton' | 'searchbutton' | 'volumeupbutton' | 'volumedownbutton',
...
declare class PlusNativeObjView {
  ...
  startAnimation(
    ...
    view: PlusNativeObjAnimationViewStyles | PlusNativeObjView,
    otherview?: PlusNativeObjAnimationViewStyles | PlusNativeObjView,
    callback?: () => void
  ): void;
  /**
   * 静态方法，关闭原生动画窗口
...
interface PlusWebview {
   ...
   */
  close(
    id_wvobj: string | PlusWebviewWebviewObject,
    aniClose?:
      | 'auto'
      | 'none'
      | 'slide-out-right'
