declare namespace UniApp {
   ...
   */
  type OffCharacteristicReadRequestCallback = (res: GeneralCallbackResult) => void;
  /**
   * 已连接的设备请求写当前外围设备的特征值事件的回调函数
   */
  type OffCharacteristicWriteRequestCallback = (res: GeneralCallbackResult) => void;
   ...
   */
  type OffBLEPeripheralConnectionStateChangedCallback = (res: GeneralCallbackResult) => void;
  /**
   ...
   */
  type OffOnVoIPVideoMembersChangedCallback = (res: GeneralCallbackResult) => void;
  /**
   * 小程序要打开的页面不存在事件的回调函数
   */
   ...
   * 实时语音通话成员视频状态变化事件的回调函数
   */
  type OnOnVoIPVideoMembersChangedCallback = (result: OnOnVoIPVideoMembersChangedCallbackResult) => void;
