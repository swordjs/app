...
var u = (function (t) {
  ...
  function tt(t, r) {
    ...
    for (var f in t)
      (!r && !F.call(t, f)) ||
        (u && ('length' == f || (o && ('offset' == f || 'parent' == f)) || (i && ('buffer' == f || 'byteLength' == f || 'byteOffset' == f)) || vt(f, a))) ||
        c.push(f);
    return c;
  }
  function rt(t, r, e) {
                  ...
                  p || _ || v
                    ...
                    ? ((l = a),
                      jt(a)
                        ...
                        : (Mt(a) && !At(a)) ||
                          (l = (function (t) {
                            return 'function' != typeof t.constructor || dt(t) ? {} : K(D(t));
                          })(f)))
                    : (h = !1);
              }
              var d, y, g, b;
    ...
    St =
      ...
      ht(function (t, r) {
        var e = -1,
          ...
          i = n > 2 ? r[2] : void 0;
        for (
          o = Ut.length > 3 && 'function' == typeof o ? (n--, o) : void 0,
            i &&
              (function (t, r, e) {
                if (!Mt(e)) return !1;
                var n = typeof r;
                return !!('number' == n ? Ot(e) && vt(r, e.length) : 'string' == n && (r in e)) && bt(e[r], t);
              })(r[0], r[1], i) &&
              ((o = n < 3 ? void 0 : o), (n = 1)),
            t = Object(t);
          ++e < n;
